...
namespace Sewa_Application.Features.Ticket.Queries.GetAllTicketsByServiceTypeAndStatus
{
    ...
    public class GetAllTicketsByServiceTypeAndStatusRequestHandler : IRequestHandler<GetAllTicketsByServiceTypeAndStatusRequest, PaginationResponse<List<TicketDto>>>
    {
        ...
        public GetAllTicketsByServiceTypeAndStatusRequestHandler(IApplicationDBContext dbContext, ICurrentUserService currentUserService, IAuthService authService, IMapper mapper)
        {
        ...
        public async Task<PaginationResponse<List<TicketDto>>> Handle(GetAllTicketsByServiceTypeAndStatusRequest request, CancellationToken cancellationToken)
        {
            ...
            var ordersList = _dbContext.Ticket.Where(p => p.OfficeId == businessUser.OfficeId &&
                                                        ...
                                                        p.Status == (ResoloutionStatusEnum)request.status &&
